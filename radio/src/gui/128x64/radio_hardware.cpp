...
enum MenuRadioHardwareItems {
  ...
  ITEM_RADIO_HARDWARE_POT5,
  ITEM_RADIO_HARDWARE_POT6,
  ITEM_RADIO_HARDWARE_POT7,
  ITEM_RADIO_HARDWARE_POT8,
  ITEM_RADIO_HARDWARE_POT9,
  ITEM_RADIO_HARDWARE_POT10,
  ITEM_RADIO_HARDWARE_POT11,
#endif
  ...
  ITEM_RADIO_HARDWARE_SS,
  ITEM_RADIO_HARDWARE_ST,
  ITEM_RADIO_HARDWARE_SU,
  ITEM_RADIO_HARDWARE_SV,
  ITEM_RADIO_HARDWARE_SW,
  ITEM_RADIO_HARDWARE_SX,
#elif NUM_SWITCHES > 4
  ITEM_RADIO_HARDWARE_SF,
  ITEM_RADIO_HARDWARE_SH,
#endif
...
#if defined(PCBSTM32F412ZG)
	#define POTS_ROWS                      NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1
#else
	#define POTS_ROWS                      NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1
#endif

#if defined(PCBSTM32F412ZG)
#define SWITCHES_ROWS                  NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1, NAVIGATION_LINE_BY_LINE|1
#elif NUM_SWITCHES > 4
...
void menuRadioHardware(event_t event)
{
  ...
  for (uint8_t i=0; i<LCD_LINES-1; i++) {
    ...
    switch(k) {
	  ...
	  case ITEM_RADIO_HARDWARE_POT5:
	  case ITEM_RADIO_HARDWARE_POT6:
	  case ITEM_RADIO_HARDWARE_POT7:
	  case ITEM_RADIO_HARDWARE_POT8:
	  case ITEM_RADIO_HARDWARE_POT9:
	  case ITEM_RADIO_HARDWARE_POT10:
	  case ITEM_RADIO_HARDWARE_POT11:
#endif
      {
      ...
      case ITEM_RADIO_HARDWARE_SS:
      case ITEM_RADIO_HARDWARE_ST:
      case ITEM_RADIO_HARDWARE_SU:
      case ITEM_RADIO_HARDWARE_SV:
      case ITEM_RADIO_HARDWARE_SW:
      case ITEM_RADIO_HARDWARE_SX:
#elif NUM_SWITCHES > 4
      case ITEM_RADIO_HARDWARE_SF:
      case ITEM_RADIO_HARDWARE_SH:
#endif
